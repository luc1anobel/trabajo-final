...
class Juego :
    ...
    def mostrar_cartas(self, pantalla,rect_imagen:dict, jugador_index: int, x_pos: int = 450, y_pos: int = 450)->dict:
        '''
    ...
    def cartas_jugador_2(self, pantalla, contador: int, x_pos: int = 250, y_pos: int = 200)->str:
    ...
    def dibujar_truco_envido_mazo (self,pantalla)->None:
        '''
        dibujar los botones de truco,envido,me voy al mazo
        '''

        for boton in [boton_truco, boton_envido, boton_mazo]:
            mouse_pos = pygame.mouse.get_pos()
            if boton_truco.collidepoint(mouse_pos):
                marco_colort = TURQUESA
            else:
                marco_colort = NEGRO

            if boton_envido.collidepoint(mouse_pos):
                marco_colore = TURQUESA
            else:
                marco_colore = NEGRO

            if boton_mazo.collidepoint(mouse_pos):
                marco_colorm = TURQUESA
            else:
                marco_colorm = NEGRO

            pygame.draw.rect(pantalla, marco_colort, boton_truco.inflate(10, 10), border_radius=5)
            pygame.draw.rect(pantalla,VERDE,boton_truco)
            pygame.draw.rect(pantalla, marco_colore, boton_envido.inflate(10, 10), border_radius=5)
            pygame.draw.rect(pantalla,VERDE,boton_envido)
            pygame.draw.rect(pantalla, marco_colorm, boton_mazo.inflate(10, 10), border_radius=5)
            pygame.draw.rect(pantalla,VERDE,boton_mazo)
        pantalla.blit(texto_truco,(boton_truco.x+7,boton_truco.y+20))
        pantalla.blit(texto_envido,(boton_envido.x+7,boton_envido.y+20))
        pantalla.blit(texto_mazo,(boton_mazo.x+2,boton_mazo.y+30))
        pygame.display.update()

    def dibujar_truco (self,pantalla)->None:
        '''
    ...
    def dibujar_envido (self,pantalla)->None:
        '''
...
#pantalla inicio
def pantalla_inicio (pantalla,puntos_maximos:int,ia:int)->None:
    '''
